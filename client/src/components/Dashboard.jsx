...
import { NavLink, useNavigate } from "react-router-dom"
 ...
 function  Dashboard(){
  ...
  year: "numeric",
    ...
    return(<div className="h-[101vh] w-[100vw] bg-emerald-200 flex flex-col gap-y-32 justify-center items-center">
        ...
        <div className="max-h-[75%] max-w-[80%] grid  grid-cols-1 md:grid-cols-3 gap-12">
            <div className="bg-emerald-100 min-h-[40vh] min-w-[25vw] rounded-lg shadow-md hover:shadow-2xl  transform hover:scale-105 transition duration-300 ease-in-out flex 
        flex-col items-center gap-y-12">
              ...
              <div className="bg-emerald-100 min-h-[40vh] min-w-[25vw] rounded-lg shadow-md hover:shadow-2xl transform hover:scale-105 transition duration-300 ease-in-out ">
                <h3 className="text-center pt-4 text-2xl font-semibold">Personal Details</h3>
                <p className="text-sm p-2 ml-5">Total Jobs Posted: {posterData.jobposted}</p>
